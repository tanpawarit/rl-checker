...
Rationale: (1) the bot path was never verified against a real Azure Bot (a deferred spike) and dragged in
...
**Supersedes:** the Teams / Bot Framework front-end in full (the earlier ADR-0004, since removed) ·
